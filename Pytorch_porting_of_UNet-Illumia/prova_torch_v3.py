...
def main():
    ...
    if rank == 0:
        ...
        np.save('/leonardo_work/DL4SF_Illumia_0/UNET_Torch/prova_train_loss_torchrun_nopref.npy', train_loss)
        np.save('/leonardo_work/DL4SF_Illumia_0/UNET_Torch/prova_val_loss_torchrun_nopref.npy', val_loss)
